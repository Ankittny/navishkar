...
const Footer: React.FC = () => {
  return (
    <>
      {/* Footer Section */}
      <section>
        <div className={`${styles.footer_namiskar} py-5 bg-dark text-white`} >
          <div className="container">
            <div className="row">
              <div className="col-lg-12  mb-4">
                <div className="footer-logo">
                  <Image src="/img/logo_second.png" alt="logo" width={150} height={50} className="img-fluid" />
                </div>
              </div>

              {/* About Us */}
              <div className="col-lg-3 mb-4">
                <div className={styles.ct_contact_us}>
                  <h3>About Us</h3>
                  <p>
      ...
      <section>
        <div className={`${styles.down_footer} text-center py-3 bg-light `}>
